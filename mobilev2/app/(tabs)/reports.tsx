  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.scanButton} onPress={() => console.log('scan tapped')}>
      ...
      <ScrollView
        ...
        <View style={styles.titleContainer}>
          ...
          <Text style={styles.pageSubtitle}>Tax, compliance, and growth metrics.</Text>
        </View>
        ...
        <View style={styles.rangeWrap}>
          <View style={styles.rangePills}>
            <TouchableOpacity
              ...
              <Text style={[styles.rangeText, range === 'month' && styles.rangeTextActive]}>
                This Month
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.rangePill, range === 'ytd' && styles.rangePillActive]}
              onPress={() => setRange('ytd')}>
              <Text style={[styles.rangeText, range === 'ytd' && styles.rangeTextActive]}>YTD</Text>
            </TouchableOpacity>
          </View>
          ...
          <>
            ...
            <View style={styles.taxCard}>
              ...
              <View style={styles.taxBody}>
                <Text style={styles.taxNote}>{insights.business_direction}</Text>
                <Text style={[styles.taxNote, { marginTop: 10, fontStyle: 'italic' }]}>
            ...
            <View style={styles.auditCard}>
              <View style={styles.auditTop}>
                <View style={[styles.auditIcon, { backgroundColor: '#fffbe6' }]}>
              ...
              <View style={styles.largeCard}>
                <View
                  ...
                  <View style={styles.purpleIcon}>
                    <MaterialIcons name="online-prediction" size={18} color="#7c3aed" />
                  </View>
                  <Text style={styles.cardTitleSmall}>Near-Term Prediction</Text>
                </View>
              ...
              {insights.risk_alerts.length > 0 && (
                <View style={styles.largeCard}>
                  <View
                    ...
                    <View style={[styles.tealIcon, { backgroundColor: '#fee2e2' }]}>
            ...
            <View style={styles.auditCard}>
              <View style={styles.auditTop}>
                <View style={[styles.auditIcon, { backgroundColor: '#f0fdf4' }]}>
        ...
        {filteredNote ? <Text style={styles.filteredNote}>{filteredNote}</Text> : null}
      </ScrollView>

      {/* Floating AI FAB */}
      <TouchableOpacity style={styles.fab} onPress={() => console.log('ask ai')}>
