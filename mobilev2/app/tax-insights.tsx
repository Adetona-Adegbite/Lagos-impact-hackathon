  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={() => console.log('help')} style={styles.iconBtn}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.actionPanel}>
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.actionSubtitle}>
              AI Compliance Check found issues that need your attention before export.
            </Text>
          </View>
        ...
        <View style={styles.summaryCard}>
          ...
          <View style={styles.summaryRow}>
            ...
            <View style={styles.summaryCol}>
              ...
              <Text style={[styles.summaryValue, { color: PRIMARY }]}>₦ 75,000</Text>
            </View>
          </View>
        ...
        <View style={styles.predictCard}>
          ...
          <Text style={styles.predictText}>
            ...
            <Text style={{ fontWeight: '800' }}>₦ 105,000</Text> for next month’s tax.
          </Text>
      ...
      <View style={styles.bottomBar}>
        ...
        <TouchableOpacity style={[styles.bottomBtn, styles.csvBtn]} onPress={exportCSV}>
          ...
          <Text style={[styles.bottomBtnText, { color: '#111' }]}>Export CSV</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
