...
export default function OnboardingScreen() {
    ...
    return (
      <View className="flex-1 bg-background justify-center p-5">
        ...
        <View className="px-5">
          ...
          <Button onPress={() => handleSetLanguage("en")} className="mb-4 rounded-full h-14">
            <Text className="font-bold text-lg text-primary-foreground">{t("english")}</Text>
          </Button>
          <Button
          ...
          >
            <Text className="font-bold text-lg text-primary">{t("pidgin")}</Text>
          </Button>
        </View>
      </View>
    );
  ...
  return (
    <View className="flex-1 bg-background">
      ...
      {/* Top Bar */}
      <View style={{ paddingTop: SAFE_TOP }} className="flex-row items-center justify-between px-5 h-24">
        <View className="w-12" />
        <View className="flex-1 items-center">
          <Text className="text-primary font-bold text-lg tracking-wider">Supamart</Text>
        </View>
            ...
            <View style={{ width }} className="flex-1 justify-center">
              <View className="flex-1 items-center justify-center">
                    ...
                    {isLast && (
                      <View className="absolute bottom-5 left-3 right-3 rounded-xl p-3 bg-background/80 border border-white/5">
                        <View className="flex-row items-center">
                          ...
                          <View className="ml-3">
                            <Text className="text-[10px] text-primary font-bold uppercase">Scanned</Text>
                            <Text className="text-foreground text-sm font-bold">Indomie 70g (Carton)</Text>
                          </View>
                        </View>
                        <View className="flex-row justify-between mt-2 items-center">
                          <Text className="text-muted-foreground text-xs">Unit Price</Text>
                          <Text className="text-foreground text-xl font-extrabold">₦5,200</Text>
                        </View>
                      </View>
                    )}
                  </ImageBackground>
                ...
                <View className="px-7 items-center">
                  ...
                  <Text variant="p" className="text-center text-muted-foreground leading-relaxed">
                    {item.subtitle}
                  </Text>
                </View>
              </View>
      ...
      <View className="px-5 pb-10 pt-2 bg-transparent">
        {slides[index].layout === "first" && (
          <View className="flex-row items-center justify-between">
            ...
            <Button onPress={goNext} size="icon" className="w-14 h-14 rounded-full p-0">
        ...
        {slides[index].layout === "middle" && (
          <View className="items-center gap-4">
            ...
            <Button onPress={goNext} className="w-full h-14 rounded-full flex-row gap-2">
