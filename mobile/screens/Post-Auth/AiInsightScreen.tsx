    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <View style={styles.titleContainer}>
          ...
          <Text style={styles.pageSubtitle}>Here's what's happening in your shop right now.</Text>
        </View>
          ...
          <View style={styles.restockHeader}>
            ...
            <View>
              ...
              <Text style={styles.restockText}>
                <Text style={{ fontWeight: "bold" }}>Indomie Chicken (70g)</Text> is predicted to run out by{" "}
                <Text style={{ fontWeight: "bold", color: "#CA8A04" }}>Friday evening</Text>.
              </Text>
            </View>
          </View>
            ...
            {[
              ...
              <View key={idx} style={styles.slowStockRow}>
                <View>
                  ...
                  <Text style={styles.stockInfo}>Last sold: {item.lastSold}</Text>
                </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.weeklyGraph}>
            {[40, 60, 30, 75, 90, 50, 20].map((height, idx) => (
              <View key={idx} style={[styles.weeklyBar, { height: `${height}%`, backgroundColor: idx === 4 ? "#36e27b" : "#E5E7EB" }]} />
            ))}
          </View>
          <Text style={styles.weeklyTip}>"Sales usually peak on Saturdays. Stock up on soft drinks tomorrow."</Text>
        </View>
      </ScrollView>
      ...
      <View style={styles.bottomNav}>
        {[
          { name: "storefront", label: "Home" },
          { name: "inventory_2", label: "Stock" },
          { name: "point-of-sale", label: "Sales" },
          { name: "insights", label: "Insights", active: true },
        ].map((item, idx) => (
          <TouchableOpacity key={idx} style={styles.navItem}>
            <MaterialIcons
              name={item.name as any}
              size={24}
              color={item.active ? "#36e27b" : "#9CA3AF"}
            />
            <Text style={[styles.navLabel, item.active && { color: "#36e27b", fontWeight: "bold" }]}>{item.label}</Text>
          </TouchableOpacity>
        ))}
      </View>
    </View>
...
const styles = StyleSheet.create({
  ...
  menuIcon: { width: 40, height: 40, borderRadius: 20, backgroundColor: "#E5E7EB", alignItems: "center", justifyContent: "center" },
  welcomeText: { fontSize: 12, color: "#9EB7A8" },
  userName: { fontSize: 16, fontWeight: "bold", color: "#111" },
  scanButton: { flexDirection: "row", alignItems: "center", backgroundColor: "#36e27b", paddingHorizontal: 16, paddingVertical: 6, borderRadius: 9999 },
  scanText: { color: "#fff", fontWeight: "bold", marginLeft: 4 },
  titleContainer: { marginVertical: 16 },
  pageTitle: { fontSize: 24, fontWeight: "bold", marginBottom: 4, color: "#111" },
  pageSubtitle: { fontSize: 14, color: "#9EB7A8" },
  card: { backgroundColor: "#fff", borderRadius: 12, padding: 16, marginBottom: 16, shadowColor: "#000", shadowOpacity: 0.05, shadowRadius: 10 },
  cardHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 8 },
  cardHeaderLeft: { flexDirection: "row", alignItems: "center", gap: 8 },
  iconCircle: { width: 24, height: 24, borderRadius: 12, backgroundColor: "#FFE4D8", alignItems: "center", justifyContent: "center" },
  iconCircleBlue: { width: 24, height: 24, borderRadius: 12, backgroundColor: "#DBEAFE", alignItems: "center", justifyContent: "center" },
  ...
  barLabel: { width: 100, fontSize: 12, color: "#9EB7A8", textAlign: "right", marginRight: 8 },
  barContainer: { flex: 1, height: 24, flexDirection: "row", alignItems: "center", backgroundColor: "#F3F4F6", borderRadius: 8, paddingHorizontal: 4 },
  ...
  restockHeader: { flexDirection: "row", alignItems: "center", gap: 12, marginBottom: 8 },
  restockIcon: { width: 40, height: 40, borderRadius: 20, backgroundColor: "#FDE68A", alignItems: "center", justifyContent: "center" },
  restockText: { fontSize: 12, color: "#555" },
  restockButton: { flexDirection: "row", alignItems: "center", justifyContent: "center", backgroundColor: "#FEF3C7", paddingVertical: 8, borderRadius: 12, marginTop: 8 },
  restockButtonText: { fontWeight: "bold", color: "#CA8A04", marginLeft: 4 },
  slowStock: { borderTopWidth: 1, borderColor: "#E5E7EB", marginTop: 8 },
  slowStockRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingVertical: 8, borderBottomWidth: 1, borderColor: "#E5E7EB" },
  ...
  viewAll: { marginTop: 8, textAlign: "center", fontSize: 14, fontWeight: "500", color: "#36e27b" },
  ...
  weeklyGraph: { flexDirection: "row", height: 120, justifyContent: "space-between", alignItems: "flex-end" },
  weeklyBar: { flex: 1, marginHorizontal: 2, borderRadius: 4 },
  weeklyTip: { marginTop: 8, fontSize: 12, color: "#9EB7A8", fontStyle: "italic" },
  fab: { position: "absolute", bottom: 80, right: 16, width: 56, height: 56, borderRadius: 28, backgroundColor: "#36e27b", alignItems: "center", justifyContent: "center" },
  bottomNav: { position: "absolute", bottom: 0, left: 0, right: 0, flexDirection: "row", justifyContent: "space-around", paddingVertical: 16, backgroundColor: "#fff", borderTopWidth: 1, borderColor: "#E5E7EB" },
